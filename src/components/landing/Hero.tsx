...
export function Hero() {
  ...
  return (
    <section ref={root} className="section-dark relative">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 blueprint-dark fade-edges" />
      ...
      <div className="gutter-x relative mx-auto grid w-full min-w-0 max-w-6xl grid-cols-1 items-center gap-8 py-10 sm:gap-12 sm:py-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:gap-10 lg:py-24">
        <div className="min-w-0 max-w-full">
          ...
          <h1 data-hero className="display-1 mt-5 w-full max-w-xl text-white">
            {t("title")}
          </h1>
          <p data-hero className="lead mt-5 w-full max-w-lg text-dark-text/80">
            {t("subtitle")}
          </p>
          <div
            data-hero
